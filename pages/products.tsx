    ...
    <Layout>
      <div className={styles.container}>
        <div className={styles.sidebar}>
          ...
          >
            Walraven<span>({walravenLenght})</span>
          </button>
        </div>
        <section>
          <p>共 {total} 筆</p>
                ...
                <>
                  <div className={styles.wrap}>
                    ...
                    <p>
                      ...
                      SPX 冷卻技術公司成立於100多年前，在製程冷卻、工業、冷凍和 HVAC 市場擁有250多項全球專利。
              ...
              {spirptechIsShow && (
                <>
                  <div className={styles.wrap}>
                    ...
                    <p>
                      SPIROTECH開發了可靠的標準和客製化解決方案，透過幫助節省能源、
                      提高舒適度、減少磨損以及最大限度地延長供暖或製冷系統的正常運行時間來提高性能並保護投資。
                    </p>
                  </div>
                  <div className={styles.itemWrap}>
                ...
                <>
                  <div className={styles.wrap}>
                    ...
                    <p>
                      ...
                      Corporation）一直採用創新、可靠的解決方案解決客戶複雜的水過濾問題。
                      我們的產品解決了全球工業製造、暖通空調、食品加工、農業、市政和其他應用的問題。
                      <br />
                      <br />
                      LAKOS在以下方面發揮關鍵作用：
                      <br />
              ...
              {waltravenIsShow && (
                <>
                  <div className={styles.wrap}>
                    ...
                    <p>
                      Walraven 成立於 1942 年的荷蘭跨國公司。如今，80 年過去了，
                      我們已成為一家活躍於全球安裝產業的公司，仍然致力於開發簡單且智慧的產品系統。
